    ...
    <div class="card">
            <div class="card-heading">
                ...
                <div>
                    ...
                    <a class="btn btn-secondary mt-2 text-sm sm:ml-1 sm:mt-0 w-full max-w-md sm:w-auto" href="{{ route('admin.personalization.menulinks.create', ['type' => 'front']) }}">{{ __('personalization.addelement') }}</a>
                </div>
                </div>
            @csrf
            @if ($errors->any())
