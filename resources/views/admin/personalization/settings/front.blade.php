    ...
    <div class="card">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 mb-4">
            <p class="text-sm text-blue-700 dark:text-blue-300 flex items-start gap-2">
                ...
                <span>Modifiez directement les elements du menu. Les dropdowns peuvent avoir des categories (niveau 2) qui contiennent des liens (niveau 3). Cliquez sur le bouton de traduction pour ajouter des traductions.</span>
            </p>
        </div>
