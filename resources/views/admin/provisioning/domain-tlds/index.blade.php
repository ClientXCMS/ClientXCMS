            ...
            <div class="border rounded-lg overflow-hidden dark:border-gray-700">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-3 text-start">{{ __($translatePrefix . '.extension') }}</th>
                        <th class="px-6 py-3 text-start">{{ __('global.status') }}</th>
                        <th class="px-6 py-3 text-start">{{ __('global.actions') }}</th>
                    </tr>
                    </thead>
                    ...
                    @empty
                        <tr><td colspan="4" class="px-6 py-4 text-center">{{ __('global.no_results') }}</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
