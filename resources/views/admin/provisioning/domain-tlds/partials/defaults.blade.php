...
<section class="mt-6" data-domain-defaults>
    ...
    <template data-nameserver-template><div class="flex gap-3" data-dns-row><input class="input-text" name="default_nameservers[]" aria-label="{{ __('provisioning.admin.domain_tlds.tools.nameservers') }}"><button type="button" class="btn btn-danger" data-remove-row>{{ __('global.delete') }}</button></div></template>
