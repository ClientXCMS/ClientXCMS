                    ...
                    <div class="card-heading">
                        <div>
                            ...
                            @if(setting('minimum_days_to_force_renewal_with_upgrade') != 0 && $service->expires_at && (new \DateTime())->diff($service->expires_at)->d < setting('minimum_days_to_force_renewal_with_upgrade'))
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ __('client.services.upgrade.minimum_days_to_force_renewal_with_upgrade', ['days' => setting('minimum_days_to_force_renewal_with_upgrade', 3)]) }}
                                </p>
                                @endif
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800 mt-2">
                            <div class="p-4 md:p-5 flex gap-x-4">
                                ...
                                <div class="grow">
                                    ...
                                    <div class="mt-1 flex items-center gap-x-2">
                                        <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">
                                            <x-service-days-remaining expires_at="{{ $service->expires_at }}" state="{{ $service->status }}" suspended_at="{{ $service->suspended_at }}" cancelled_at="{{ $service->suspended_at }}"></x-service-days-remaining>
                                        </h3>
                                    </div>
                                </div>
                            </div>
