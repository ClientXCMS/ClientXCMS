...
<main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg border-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    @foreach(app('theme')->getFrontLinks() as $link)
                        <li class="nav-item">
                            <a href="{{ $link->trans('url') }}" class="nav-link {{ is_subroute($link->trans('url')) ? 'active' : '' }}">
            ...
            <div class="container">
                <ul class="navbar-nav">
                    @foreach(\App\Http\Navigation\ClientNavigationMenu::getItems() as  $item)
                        <li class="nav-item {{ is_subroute(route($item['route'])) && $item['route'] != 'front.client.index' ? 'active' : '' }}">
        ...
        <div class="main-content bg-body-secondary" style="min-height: 300px;">
