                ...
                @endphp
                <article data-domain-card="{{ $result['domain'] }}" class="flex flex-col gap-4 rounded-2xl border {{ $featured ? 'border-indigo-200 bg-indigo-50/40 dark:border-indigo-800 dark:bg-indigo-950/20' : 'border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800' }} p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
                    <div class="min-w-0">
