...
return [
  ...
  'departmentsseeder' => [
    ...
    'general' => [
      'description' => 'Para consultas generales y asistencia',
      'name' => 'General',
    ],
  ],
  'security_questions' => [
    'pet_name' => '¿Cuál es el nombre de su primera mascota?',
    'birth_city' => '¿En qué ciudad nació usted?',
    'mother_maiden_name' => '¿Cuál es el nombre de soltera de su madre?',
    'first_school' => '¿Cuál es el nombre de su primera escuela?',
    'favorite_movie' => '¿Cuál es su película favorita?',
    'childhood_nickname' => '¿Cuál era su apodo de infancia?',
  ],
];
