...
class ExtensionServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $service->addCardItem('personalization', 'footer_menu', 'personalization.footer_menu.title', 'personalization.footer_menu.description', 'bi bi-layout-three-columns', [SettingsPersonalizationController::class, 'showFooterMenu'], Permission::MANAGE_PERSONALIZATION);
